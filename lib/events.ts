...
export const EVENTS: EventDef[] = [
  ...
  { id: "60m", name: "60m", kind: "track", unit: "s", lowerIsBetter: true },
  { id: "80m", name: "80m", kind: "track", unit: "s", lowerIsBetter: true },
  { id: "150m", name: "150m", kind: "track", unit: "s", lowerIsBetter: true },
  { id: "300m", name: "300m", kind: "track", unit: "s", lowerIsBetter: true },
  { id: "500m", name: "500m", kind: "track", unit: "s", lowerIsBetter: true },
  { id: "600m", name: "600m", kind: "track", unit: "s", lowerIsBetter: true },
  { id: "1000m", name: "1000m", kind: "track", unit: "s", lowerIsBetter: true },
  { id: "2000m", name: "2000m", kind: "track", unit: "s", lowerIsBetter: true },
  { id: "3000m", name: "3000m", kind: "track", unit: "s", lowerIsBetter: true },
  { id: "5000m", name: "5000m", kind: "track", unit: "s", lowerIsBetter: true },
  { id: "10000m", name: "10000m", kind: "track", unit: "s", lowerIsBetter: true },
  { id: "60mH", name: "60m Hurdles", kind: "track", unit: "s", lowerIsBetter: true },
  { id: "80mH", name: "80m Hurdles", kind: "track", unit: "s", lowerIsBetter: true },
  { id: "300mH", name: "300m Hurdles", kind: "track", unit: "s", lowerIsBetter: true },
  { id: "1500mSC", name: "1500m Steeplechase", kind: "track", unit: "s", lowerIsBetter: true },
  { id: "2000mSC", name: "2000m Steeplechase", kind: "track", unit: "s", lowerIsBetter: true },
  { id: "3000mSC", name: "3000m Steeplechase", kind: "track", unit: "s", lowerIsBetter: true },
  { id: "1000mRW", name: "1000m Race Walk", kind: "track", unit: "s", lowerIsBetter: true },
  { id: "2000mRW", name: "2000m Race Walk", kind: "track", unit: "s", lowerIsBetter: true },
  { id: "3000mRW", name: "3000m Race Walk", kind: "track", unit: "s", lowerIsBetter: true },
  { id: "5000mRW", name: "5000m Race Walk", kind: "track", unit: "s", lowerIsBetter: true },
  { id: "10000mRW", name: "10000m Race Walk", kind: "track", unit: "s", lowerIsBetter: true },
  { id: "PV", name: "Pole Vault", kind: "field", unit: "m", lowerIsBetter: false },
  { id: "DT", name: "Discus Throw", kind: "field", unit: "m", lowerIsBetter: false },
  { id: "HT", name: "Hammer Throw", kind: "field", unit: "m", lowerIsBetter: false },
]
