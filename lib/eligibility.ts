...
const OUTDOOR: Record<Category, string[]> = {
  U12: ["60m", "500m", "1000m", "2000m", "60mH", "LJ", "HJ", "TJ", "PV", "SP", "DT", "JT", "HT", "2000mRW"],
  ...
  U23: ["100m", "200m", "400m", "800m", "1500m", "3000m", "5000m", "10000m", "110mH", "400mH", "3000mSC", "10000mRW", ...COMMON_FIELD],
  Senior: ["100m", "200m", "400m", "800m", "1500m", "3000m", "5000m", "10000m", "110mH", "400mH", "3000mSC", "10000mRW", ...COMMON_FIELD],
  Master: ["100m", "200m", "400m", "800m", "1500m", "3000m", "5000m", "10000m", "110mH", "400mH", "3000mSC", "10000mRW", ...COMMON_FIELD],
};

const SHORT_TRACK: Record<Category, string[]> = {
  U12: ["60m", "500m", "1000m", "60mH", "600mRW", "LJ", "HJ", "TJ", "PV", "SP", "DT", "JT", "HT"],
  U14: ["60m", "80m", "500m", "1000m", "2000m", "60mH", "80mH", "2000mRW", ...COMMON_FIELD],
  U16: ["60m", "300m", "600m", "1000m", "3000m", "60mH", "LJ", "HJ", "TJ", "PV", "SP", "DT", "JT", "HT"],
  U18: ["60m", "200m", "400m", "800m", "1500m", "3000m", "60mH", "LJ", "HJ", "TJ", "PV", "SP", "DT", "JT", "HT"],
  U20: ["60m", "200m", "400m", "800m", "1500m", "3000m", "60mH", "LJ", "HJ", "TJ", "PV", "SP", "DT", "JT", "HT"],
  U23: ["60m", "200m", "400m", "800m", "1500m", "3000m", "60mH", "LJ", "HJ", "TJ", "PV", "SP", "DT", "JT", "HT"],
  Senior: ["60m", "200m", "400m", "800m", "1500m", "3000m", "60mH", "LJ", "HJ", "TJ", "PV", "SP", "DT", "JT", "HT"],
  Master: ["100m", "200m", "400m", "800m", "1500m", "3000m", "5000m", "10000m", "110mH", "400mH", "3000mSC", "10000mRW", ...COMMON_FIELD],
};
...
export function isEventAllowed(
  ...
  // Hurdle distances are sex/category specific.
  if (eventId === "110mH") {
    return sex === "M" && ["U18", "U20", "U23", "Senior"].includes(category);
  }

  if (eventId === "100mH") {
    return ["U16", "U18", "U20", "U23", "Senior"].includes(category);
  }

  if (eventId === "80mH") {
    return ["U14"].includes(category);
  }
